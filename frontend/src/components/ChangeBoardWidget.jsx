...
const ChangeBoardWidget = ({ userBoards, updateCurrentBoard }) => {
    ...
    return (
        <div className="relative">
            ...
            <div className={`${isMenuVisible ? 'flex' : 'hidden'} flex-col absolute top-[calc(100%+4px)] -left-2 bg-white text-gray-800 w-[120px] max-h-[20dvh] border rounded-sm py-2 z-50`} ref={menuRef}>
